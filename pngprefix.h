...
#define png_XYZ_from_xy wx_png_XYZ_from_xy
#define png_XYZ_normalize wx_png_XYZ_normalize
#define png_build_16bit_table wx_png_build_16bit_table
#define png_build_16to8_table wx_png_build_16to8_table
#define png_build_8bit_table wx_png_build_8bit_table
#define png_cache_unknown_chunk wx_png_cache_unknown_chunk
#define png_colormap_compose wx_png_colormap_compose
#define png_colorspace_check_XYZ wx_png_colorspace_check_XYZ
#define png_colorspace_check_gamma wx_png_colorspace_check_gamma
#define png_colorspace_check_xy wx_png_colorspace_check_xy
#define png_colorspace_endpoints_match wx_png_colorspace_endpoints_match
#define png_colorspace_set_xy_and_XYZ wx_png_colorspace_set_xy_and_XYZ
#define png_compare_ICC_profile_with_sRGB wx_png_compare_ICC_profile_with_sRGB
#define png_create_colormap_entry wx_png_create_colormap_entry
#define png_decompress_chunk wx_png_decompress_chunk
#define png_default_error wx_png_default_error
#define png_default_warning wx_png_default_warning
#define png_deflate_claim wx_png_deflate_claim
#define png_digit wx_png_digit
...
#define png_fixed_inches_from_microns wx_png_fixed_inches_from_microns
#define png_format_buffer wx_png_format_buffer
#define png_fp_add wx_png_fp_add
#define png_fp_sub wx_png_fp_sub
#define png_gamma_not_sRGB wx_png_gamma_not_sRGB
#define png_gamma_threshold wx_png_gamma_threshold
#define png_get_cICP wx_png_get_cICP
#define png_get_fixed_point wx_png_get_fixed_point
#define png_handle_cICP wx_png_handle_cICP
#define png_icc_profile_error wx_png_icc_profile_error
#define png_icc_tag_char wx_png_icc_tag_char
#define png_icc_tag_name wx_png_icc_tag_name
#define png_image_format wx_png_image_format
#define png_image_free_function wx_png_image_free_function
#define png_image_memory_read wx_png_image_memory_read
#define png_image_read_and_map wx_png_image_read_and_map
#define png_image_read_background wx_png_image_read_background
#define png_image_read_colormap wx_png_image_read_colormap
#define png_image_read_colormapped wx_png_image_read_colormapped
#define png_image_read_composite wx_png_image_read_composite
#define png_image_read_direct wx_png_image_read_direct
#define png_image_read_header wx_png_image_read_header
#define png_image_read_init wx_png_image_read_init
...
#define png_inflate wx_png_inflate
#define png_inflate_claim wx_png_inflate_claim
#define png_inflate_read wx_png_inflate_read
#define png_init_filter_functions wx_png_init_filter_functions
#define png_init_filter_functions_sse2 wx_png_init_filter_functions_sse2
#define png_init_palette_transformations wx_png_init_palette_transformations
#define png_init_rgb_transformations wx_png_init_rgb_transformations
#define png_malloc_array_checked wx_png_malloc_array_checked
#define png_pass_inc wx_png_pass_inc
#define png_pass_start wx_png_pass_start
#define png_pass_yinc wx_png_pass_yinc
#define png_pass_ystart wx_png_pass_ystart
#define png_pow10 wx_png_pow10
#define png_product2 wx_png_product2
#define png_read_buffer wx_png_read_buffer
#define png_read_destroy wx_png_read_destroy
#define png_read_filter_row_avg wx_png_read_filter_row_avg
#define png_read_filter_row_avg3_sse2 wx_png_read_filter_row_avg3_sse2
#define png_read_filter_row_avg4_sse2 wx_png_read_filter_row_avg4_sse2
#define png_read_filter_row_paeth3_sse2 wx_png_read_filter_row_paeth3_sse2
#define png_read_filter_row_paeth4_sse2 wx_png_read_filter_row_paeth4_sse2
#define png_read_filter_row_paeth_1byte_pixel wx_png_read_filter_row_paeth_1byte_pixel
#define png_read_filter_row_paeth_multibyte_pixel wx_png_read_filter_row_paeth_multibyte_pixel
...
#define png_setup_avg_row wx_png_setup_avg_row
#define png_setup_avg_row_only wx_png_setup_avg_row_only
#define png_setup_paeth_row wx_png_setup_paeth_row
#define png_setup_paeth_row_only wx_png_setup_paeth_row_only
#define png_setup_sub_row wx_png_setup_sub_row
#define png_setup_sub_row_only wx_png_setup_sub_row_only
#define png_setup_up_row wx_png_setup_up_row
#define png_setup_up_row_only wx_png_setup_up_row_only
#define png_text_compress wx_png_text_compress
#define png_text_compress_init wx_png_text_compress_init
#define png_unpremultiply wx_png_unpremultiply
#define png_write_cICP wx_png_write_cICP
#define png_write_chunk_header wx_png_write_chunk_header
#define png_write_complete_chunk wx_png_write_complete_chunk
#define png_write_compressed_data_out wx_png_write_compressed_data_out
#define png_write_destroy wx_png_write_destroy
#define png_write_filtered_row wx_png_write_filtered_row
#define png_write_image_16bit wx_png_write_image_16bit
#define png_write_image_8bit wx_png_write_image_8bit
#define png_xy_from_XYZ wx_png_xy_from_XYZ

#define png_ensure_fcTL_is_valid wx_png_ensure_fcTL_is_valid
#define png_ensure_sequence_number wx_png_ensure_sequence_number
#define png_handle_acTL wx_png_handle_acTL
#define png_handle_fcTL wx_png_handle_fcTL
#define png_handle_fdAT wx_png_handle_fdAT
#define png_have_info wx_png_have_info
#define png_progressive_read_reset wx_png_progressive_read_reset
#define png_read_reinit wx_png_read_reinit
...
#define png_write_acTL wx_png_write_acTL
#define png_write_fcTL wx_png_write_fcTL
#define png_write_reinit wx_png_write_reinit
#define png_write_reset wx_png_write_reset
#define png_read_frame_head wx_png_read_frame_head
#define png_write_fdAT wx_png_write_fdAT
